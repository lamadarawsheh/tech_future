            ...
            <div className="flex flex-1 justify-end gap-4 items-center">
              ...
              >
                ...
                <input
                  ...
                  className={`block w-full rounded-full border bg-slate-50 dark:bg-slate-800/50 pl-11 pr-16 py-2.5 text-sm font-medium placeholder-slate-400 text-slate-900 dark:text-white transition-all shadow-sm focus:outline-none ${
                    searchFocused
