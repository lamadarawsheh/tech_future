...
import { AcademyHeader, AcademyFooter } from "@/components/AcademyLayout";

export const metadata: Metadata = {
    title: "Lesson | Bot & Beam Academy",
    description: "Learn coding concepts step by step",
    icons: {
...
export default function LessonLayout({
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 animate-fade-in transition-colors duration-300">
            <div className="fixed inset-0 -z-10 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 animate-gradient transition-colors duration-300"></div>
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full blur-3xl animate-pulse-slow"></div>
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/10 dark:bg-cyan-500/5 rounded-full blur-3xl animate-pulse-slow animation-delay-2000"></div>
            </div>
