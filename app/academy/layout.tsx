...
import { AcademyGuard } from "../../src/components/AcademyGuard";

export const metadata: Metadata = {
    title: "Bot & Beam Academy | Master Coding Skills",
    description: "Interactive coding challenges, structured learning paths, and competitive programming.",
    icons: {
    ...
    openGraph: {
        title: "Bot & Beam Academy",
        description: "Master coding through interactive challenges and structured learning",
        siteName: "Bot & Beam Academy",
    }
};
