...
const Problem: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [slug]); // Only depend on slug, not subscriber or language
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1 text-slate-400 hover:text-white transition px-2 py-1 rounded hover:bg-slate-800"
                >
                  <span className="material-symbols-outlined text-sm">
                    palette
                  </span>
