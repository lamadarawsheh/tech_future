...
const Challenges: React.FC = () => {
  ...
  if (slug && currentPath) {
    ...
    const sortedPath = { ...currentPath, chapters: sortedChapters.map(ch => ({
      ...ch,
    ...
    return (
      <div className="min-h-screen -mt-10 -mx-4 sm:-mx-6 lg:-mx-8 bg-slate-950">
        {/* Header */}
        <div className="bg-gradient-to-r from-slate-900 via-cyan-900/30 to-slate-900 border-b border-slate-700/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Link to="/challenges" className="text-slate-400 hover:text-white transition">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white font-display">CodeFlow</h1>
                  <p className="text-xs text-slate-400">Learning Path</p>
                </div>
              </div>
              ...
              {profile && (
                <div className="flex items-center gap-2 bg-slate-800/50 px-3 py-1.5 rounded-lg">
                  ...
                  <span className="text-white font-medium text-sm">{profile.xp?.toLocaleString()} XP</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-5">
                <p className="text-cyan-400 text-xs font-medium mb-2">Current Campaign</p>
                <h2 className="text-xl font-bold text-white mb-2">{sortedPath.title}</h2>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <p className={`font-medium text-sm ${isLocked ? 'text-slate-600' : 'text-white'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white font-display">CodeFlow</h1>
                <p className="text-xs text-slate-400">Learning Paths</p>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link to="/challenges" className="text-cyan-400 font-medium text-sm">Challenges</Link>
            </nav>
          </div>
        </div>
      </div>
            ...
            <>
              {[
                ...
                <Link
                  ...
                  className="group bg-slate-900/50 hover:bg-slate-800/50 border border-slate-800 hover:border-slate-700 rounded-2xl p-6 transition"
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 text-slate-500 text-sm group-hover:text-cyan-400 transition">
                      Start Learning
